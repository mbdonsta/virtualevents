    ...
    <div class="mb-10">
        ...
        <div class="card pt-20 card-flush">
            ...
            @if ($eventDays->isEmpty())
                <div class="card-body">
                    <p class="text-center">{{ __("This event do not have any program days.") }}</p>
                    @can('create', [App\Model\EventProgram::class, $event])
                        <div class="text-center">
                            <a href="{{ route('backend.program.add', ['event' => $event->id]) }}"
                               class="btn btn-primary">{{ __('Create program day') }}</a>
                        </div>
                    @endcan
                </div>
            @else
                        ...
                        <div class="table-responsive overflow-visible">
                            <table class="table align-middle table-row-dashed events-table fs-6 gy-5 no-footer"
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="min-w-175px sorting">{{ __('Day name') }}</th>
                                                ...
                                                <div
                                                    ...
                                                    @can('edit', $eventDay)
                                                        ...
                                                        <div class="menu-item py-0">
                                                            <a href="{{ route('backend.program.edit', ['eventProgram' => $eventDay->id]) }}"
                                                    ...
                                                    @can('delete', $eventDay)
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item py-0">
                                                            <a href="{{ route('backend.program.delete', ['eventProgram' => $eventDay->id]) }}"
                                                               class="menu-link px-3"
                                                               onclick="return confirm('{{ __('Are you sure you want to delete :name event day?', ['name' => $eventDay->name]) }}')"
                                                            >{{ __('Delete') }}</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    @endcan
