...
@section('event_wrapper_content')
    ...
    <div class="card card-flush">
        <!--begin::Card body-->
        <div class="card-body">
            <form action="{{ route('backend.posters.update', ['eventPoster' => $eventPoster->id]) }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control @error('author') is-invalid @enderror"
                                   name="author" value="{{ old('author', $eventPoster->author) }}">
                            @error('author')
                        ...
                        <div class="mb-10">
                            ...
                            <textarea
                                ...
                                name="description">{{ old('description', $eventPoster->description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-10">
                            ...
                            <input
                                ...
                                name="youtube_url"
                                value="{{ old('youtube_url', $eventPoster->youtube_url) }}">
                            @error('youtube_url')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-10">
                            ...
                            <image-upload
                                ...
                                file_id="{{ old('poster_image_id', $eventPoster->poster_image_id) }}"
                                file_url="{{ $eventPoster->getPosterImageUrl() ? old('poster_image_url', $eventPoster->getPosterImageUrl()) : old('poster_image_url') }}"
